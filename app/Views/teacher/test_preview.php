...
<body>
        ...
        <div class="header-content">
            <div class="logo">
                ...
                <div class="breadcrumb">
                    <a href="/teacher/decks" data-translate-key="test_preview_breadcrumb_decks">Колоды</a> → 
                    <a href="/teacher/test-manager?deck_id=<?php echo $current_test['deck_id']; ?>" data-translate-key="test_preview_breadcrumb_tests">Тесты</a> → 
                    <span data-translate-key="test_preview_breadcrumb_preview">Просмотр</span>
                </div>
            </div>
            <div class="nav-links">
                <a href="/teacher/test-edit?test_id=<?php echo $test_id; ?>" class="btn btn-primary" data-translate-key="edit_test_button">✏️ Редактировать</a>
                <a href="/teacher/test-manager?deck_id=<?php echo $current_test['deck_id']; ?>" class="btn" data-translate-key="back_button">← Назад</a>
                <a href="/logout" class="btn" data-translate-key="logout_button">Выйти</a>
            </div>
        </div>
    </header>
    ...
    <div class="container">
        ...
        <?php if (empty($questions)): ?>
            <div class="question-card">
                <p style="text-align: center; color: #666; font-style: italic;">
                    ...
                    <a href="/teacher/test-edit?test_id=<?php echo $test_id; ?>" data-translate-key="add_questions_link">Добавьте вопросы</a> 
        ...
        <div class="actions">
            <a href="/teacher/test-edit?test_id=<?php echo $test_id; ?>" class="btn btn-primary" data-translate-key="edit_test_action">✏️ Редактировать тест</a>
            <a href="/teacher/test-manager?deck_id=<?php echo $current_test['deck_id']; ?>" class="btn" data-translate-key="return_to_tests_action">← Вернуться к тестам</a>
        </div>
    </div>
</body>
</html>
