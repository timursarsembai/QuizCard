        ...
        <div class="header-content">
            <div class="logo">
                ...
                <div class="breadcrumb">
                    <a href="/teacher/decks" data-translate-key="test_edit_breadcrumb_decks">Колоды</a> → 
                    <a href="/teacher/test-manager?deck_id=<?php echo $current_test['deck_id']; ?>" data-translate-key="test_edit_breadcrumb_tests">Тесты</a> → 
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div class="form-actions">
                ...
                <a href="/teacher/test-preview?test_id=<?php echo $test_id; ?>" class="btn btn-info" data-translate-key="preview_test_button">👁️ Предварительный просмотр</a>
                <a href="/teacher/test-manager?deck_id=<?php echo $current_test['deck_id']; ?>" class="btn btn-secondary" data-translate-key="cancel_button">❌ Отмена</a>
            </div>
        </form>
    </div>
    ...
    <script>
        ...
        function updateQuestionNumbers() {
            ...
            questionCards.forEach((card, index) => {
                ...
                numberSpan.innerHTML = `<span data-translate-key="question_prefix">Вопрос</span> ${index + 1}`;
            });
        }
